...
syntax match hsEmptySet "()" conceal cchar=∅
...
if !Cf('𝐒')
    syntax match hsNiceOperator "\<String\>"  conceal cchar=𝑆
endif
...
syntax match hsNiceSpecial "\<True\>"  conceal cchar=⊤
syntax match hsNiceSpecial "\<False\>" conceal cchar=⊥
